...
export function getPlaceholderImage({ category, type, width = 800, height = 600 }: PlaceholderImageProps): string {
  // Color schemes for different categories
  const colorSchemes: Record<string, { before: string; after: string }> = {
    apparel: {
