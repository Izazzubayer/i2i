...
Total file size: ${formatFileSize(images.reduce((accfile) => acc + file.size0))}
...
All processed images will maintain original quality while applying the requested enhancements. The system will automatically detect and optimize each image based on its content and composition.`
  ...
  const totalSize = images.reduce((accfile) => acc + file.size0)
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload images to process (PNGJPGWEBP)
              </CardDescription>
            </CardHeader>
