...
export default function RetouchDrawer() {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      // In a real appthis would call the API
      // const result = await apiClient.retouch(selectedImageForRetouch.idinstruction)
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden rounded-lg border">
                    {selectedImageForRetouch.processedUrl ? (
                      <Image
                        ...
                        sizes="(max-width: 768px) 100vw50vw"
                      />
                    ) : (
                  ...
                  <div className="rounded-lg border bg-muted/30 p-4">
                    ...
                    <ul className="space-y-1 text-sm text-muted-foreground">
                      <li className="flex gap-2">
                        <span>•</span>
                        <span>Be specific about colorsbrightnessand contrast</span>
                      </li>
                      <li className="flex gap-2">
                        <span>•</span>
                        <span>Mention specific areas if needed (foregroundbackground)</span>
                      </li>
                      <li className="flex gap-2">
                        <span>•</span>
