...
export default function Walkthrough({
  ...
  useEffect(() => {
    if (step?.targetSelector) {
      ...
      if (element) {
        ...
        updateBubblePosition(elementstep.position || 'bottom')
  ...
  const updateBubblePosition = (element, position) => {
