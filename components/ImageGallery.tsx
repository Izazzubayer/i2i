...
import type { ProcessedImage, ImageStatus } from '@/lib/store'
...
type FilterMode = 'all' | 'approved' | 'needs-retouch' | 'completed' | 'processing'
...
export default function ImageGallery() {
  ...
  // Individual actions
  const handleApprove = (image: ProcessedImage) => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        {/* Toolbar with filters, view mode, and selection */}
