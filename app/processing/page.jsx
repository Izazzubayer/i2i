...
const processedImages = [
  {
    ...
    versions: [
      {
        id: 'v1',
        prompt: 'Apply cinematic tone; ensure brand palette (deep bluesneutral highlights)',
      ...
      {
        id: 'v2',
        prompt: 'Enhance contrast and saturationmaintain architectural details',
      ...
      {
        id: 'v3',
        prompt: 'Apply cinematic tone; ensure brand palette (deep bluesneutral highlights). Maintain detail in architecture and skin tones.',
        processedUrl: 'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&w=1600&q=80',
        timestamp: '15:22',
        actor: 'Eileen Chen',
      },
  ...
  },
  {
    ...
    versions: [
      ...
      {
        id: 'v2',
        prompt: 'Enhance natural lightingboost greens and blues',
        processedUrl: 'https://images.unsplash.com/photo-1519682337058-a94d519337bc?auto=format&fit=crop&w=1600&q=80',
        timestamp: '15:22',
        actor: 'Eileen Chen',
      },
  ...
  },
  {
    ...
    versions: [
      {
        id: 'v1',
        prompt: 'Warm sunrise tonesenhance golden hour glow',
        processedUrl: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1600&q=80',
        timestamp: '14:01',
        actor: 'i2i Automations',
      },
  ...
  },
  {
    ...
    versions: [
      {
        id: 'v1',
        prompt: 'Clean white backgroundenhance product details',
...
export default function ProcessingOverviewPage() {
  ...
  const [expandedFolders, setExpandedFolders] = useState(new Set([projects[0].id]))
  ...
  const [revertImageId, setRevertImageId] = useState(null)
  ...
  const filteredImages = useMemo(() => {
    ...
    // If no folder selectedshow images from active project's folders
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Select visuals to approveretouchor export.</p>
                </div>
            ...
            <Card className="select-none">
              <CardHeader className="pb-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Immutable audit trail of editsapprovalsdownloadsand DAM transfers.
                </p>
              </CardHeader>
